// Props & scenery voxel data: palms, flowers, micro-props, chamber set pieces,
// world landmarks, and the hub shop buildings. Pure data, consumed via
// src/models.js (see it for the palette + bottom-up Y-layer model format).
