...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function yu(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fc(),fragmentShader:`
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function Su(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fc(),fragmentShader:`
	...
	`}function p0(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Vo||l===Wo,u=l===vs||l===bs;if(c||u){let d=e.get(o);const h=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==h)return t===null&&(t=new bu(i)),d=c?t.fromEquirectangular(o,d):t.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),d.texture;if(d!==void 0)return d.texture;{const f=o.image;return c&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new bu(i)),d=c?t.fromEquirectangular(o):t.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function m0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&nr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function g0(i,e,t,n){const s={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,g=d.attributes.position;let v=0;if(f!==null){const T=f.array;v=f.version;for(let w=0,S=T.length;w<S;w+=3){const P=T[w+0],R=T[w+1],L=T[w+2];h.push(P,R,R,L,L,P)}}else if(g!==void 0){const T=g.array;v=g.version;for(let w=0,S=T.length/3-1;w<S;w+=3){const P=w+0,R=w+1,L=w+2;h.push(P,R,R,L,L,P)}}else return;const m=new(Md(h)?Ad:Td)(h,1);m.version=v;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function _0(i,e,t){let n;function s(h){n=h}let r,a;function o(h){r=h.type,a=h.bytesPerElement}function l(h,f){i.drawElements(n,f,r,h*a),t.update(f,n,1)}function c(h,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,h*a,g),t.update(f,n,g))}function u(h,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,h,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function d(h,f,g,v){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/a,f[p],v[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,h,0,v,0,g);let p=0;for(let T=0;T<g;T++)p+=f[T]*v[T];t.update(p,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function v0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function b0(i,e,t){const n=new WeakMap,s=new mt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==d){let y=function(){L.dispose(),n.delete(o),o.removeEventListener("dispose",y)};h!==void 0&&h.texture.dispose();const f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let w=0;f===!0&&(w=1),g===!0&&(w=2),v===!0&&(w=3);let S=o.attributes.position.count*w,P=1;S>e.maxTextureSize&&(P=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const R=new Float32Array(S*P*4*d),L=new wd(R,S,P,d);L.type=wn,L.needsUpdate=!0;const N=w*4;for(let x=0;x<d;x++){const k=m[x],z=p[x],V=T[x],q=S*P*4*x;for(let X=0;X<k.count;X++){const $=X*N;f===!0&&(s.fromBufferAttribute(k,X),R[q+$+0]=s.x,R[q+$+1]=s.y,R[q+$+2]=s.z,R[q+$+3]=0),g===!0&&(s.fromBufferAttribute(z,X),R[q+$+4]=s.x,R[q+$+5]=s.y,R[q+$+6]=s.z,R[q+$+7]=0),v===!0&&(s.fromBufferAttribute(V,X),R[q+$+8]=s.x,R[q+$+9]=s.y,R[q+$+10]=s.z,R[q+$+11]=V.itemSize===4?s.w:1)}}h={count:d,texture:L,size:new ze(S,P)},n.set(o,h),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let v=0;v<c.length;v++)f+=c[v];const g=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function x0(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,d=e.get(l,u);if(s.get(d)!==c&&(e.update(d),s.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;s.get(h)!==c&&(h.update(),s.set(h,c))}return d}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const Od=new Ft,Mu=new Id(1,1),zd=new wd,Gd=new Vf,Hd=new Pd,wu=[],Eu=[],Tu=new Float32Array(16),Au=new Float32Array(9),Ru=new Float32Array(4);function Cs(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=wu[s];if(r===void 0&&(r=new Float32Array(s),wu[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function wt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Et(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ka(i,e){let t=Eu[e];t===void 0&&(t=new Int32Array(e),Eu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function y0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function S0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2fv(this.addr,e),Et(t,e)}}function M0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;i.uniform3fv(this.addr,e),Et(t,e)}}function w0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4fv(this.addr,e),Et(t,e)}}function E0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(wt(t,n))return;Ru.set(n),i.uniformMatrix2fv(this.addr,!1,Ru),Et(t,n)}}function T0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(wt(t,n))return;Au.set(n),i.uniformMatrix3fv(this.addr,!1,Au),Et(t,n)}}function A0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(wt(t,n))return;Tu.set(n),i.uniformMatrix4fv(this.addr,!1,Tu),Et(t,n)}}function R0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function C0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2iv(this.addr,e),Et(t,e)}}function P0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3iv(this.addr,e),Et(t,e)}}function k0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4iv(this.addr,e),Et(t,e)}}function L0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function D0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2uiv(this.addr,e),Et(t,e)}}function F0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3uiv(this.addr,e),Et(t,e)}}function I0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4uiv(this.addr,e),Et(t,e)}}function U0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Mu.compareFunction=Sd,r=Mu):r=Od,t.setTexture2D(e||r,s)}function N0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Gd,s)}function B0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Hd,s)}function O0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||zd,s)}function z0(i){switch(i){case 5126:return y0;case 35664:return S0;case 35665:return M0;case 35666:return w0;case 35674:return E0;case 35675:return T0;case 35676:return A0;case 5124:case 35670:return R0;case 35667:case 35671:return C0;case 35668:case 35672:return P0;case 35669:case 35673:return k0;case 5125:return L0;case 36294:return D0;case 36295:return F0;case 36296:return I0;case 35678:case 36198:case 36298:case 36306:case 35682:return U0;case 35679:case 36299:case 36307:return N0;case 35680:case 36300:case 36308:case 36293:return B0;case 36289:case 36303:case 36311:case 36292:return O0}}function G0(i,e){i.uniform1fv(this.addr,e)}function H0(i,e){const t=Cs(e,this.size,2);i.uniform2fv(this.addr,t)}function V0(i,e){const t=Cs(e,this.size,3);i.uniform3fv(this.addr,t)}function W0(i,e){const t=Cs(e,this.size,4);i.uniform4fv(this.addr,t)}function $0(i,e){const t=Cs(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function q0(i,e){const t=Cs(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function j0(i,e){const t=Cs(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function K0(i,e){i.uniform1iv(this.addr,e)}function X0(i,e){i.uniform2iv(this.addr,e)}function Y0(i,e){i.uniform3iv(this.addr,e)}function Z0(i,e){i.uniform4iv(this.addr,e)}function Q0(i,e){i.uniform1uiv(this.addr,e)}function J0(i,e){i.uniform2uiv(this.addr,e)}function e_(i,e){i.uniform3uiv(this.addr,e)}function t_(i,e){i.uniform4uiv(this.addr,e)}function n_(i,e,t){const n=this.cache,s=e.length,r=ka(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||Od,r[a])}function i_(i,e,t){const n=this.cache,s=e.length,r=ka(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Gd,r[a])}function s_(i,e,t){const n=this.cache,s=e.length,r=ka(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Hd,r[a])}function r_(i,e,t){const n=this.cache,s=e.length,r=ka(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||zd,r[a])}function a_(i){switch(i){case 5126:return G0;case 35664:return H0;case 35665:return V0;case 35666:return W0;case 35674:return $0;case 35675:return q0;case 35676:return j0;case 5124:case 35670:return K0;case 35667:case 35671:return X0;case 35668:case 35672:return Y0;case 35669:case 35673:return Z0;case 5125:return Q0;case 36294:return J0;case 36295:return e_;case 36296:return t_;case 35678:case 36198:case 36298:case 36306:case 35682:return n_;case 35679:case 36299:case 36307:return i_;case 35680:case 36300:case 36308:case 36293:return s_;case 36289:case 36303:case 36311:case 36292:return r_}}class o_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=z0(t.type)}}class l_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=a_(t.type)}}class c_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const So=/(\w+)(\])?(\[|\.)?/g;function Cu(i,e){i.seq.push(e),i.map[e.id]=e}function u_(i,e,t){const n=i.name,s=n.length;for(So.lastIndex=0;;){const r=So.exec(n),a=So.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Cu(t,c===void 0?new o_(o,i,e):new l_(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new c_(o),Cu(t,d)),t=d}}}class ra{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);u_(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Pu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const d_=37297;let h_=0;function f_(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const ku=new Ne;function p_(i){Ke._getMatrix(ku,Ke.workingColorSpace,i);const e=`mat3( ${ku.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case ha:return[e,"LinearTransferOETF"];case et:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Lu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}function g_(i,e){let t;switch(e){case _f:t="Linear";break;case vf:t="Reinhard";break;case bf:t="Cineon";break;case xf:t="ACESFilmic";break;case Sf:t="AgX";break;case Mf:t="Neutral";break;case yf:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const jr=new D;function __(){Ke.getLuminanceCoefficients(jr);const i=jr.x.toFixed(4),e=jr.y.toFixed(4),t=jr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function v_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(qs).join(`
`)}function b_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function x_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function qs(i){return i!==""}function Du(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Fu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const y_=/^[ \t]*#include +<([\w\d./]+)>/gm;function El(i){return i.replace(y_,M_)}const S_=new Map;function M_(i,e){let t=Oe[e];if(t===void 0){const n=S_.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return El(t)}const w_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Iu(i){return i.replace(w_,E_)}function E_(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Uu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function T_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===dd?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===hd?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===On&&(e="SHADOWMAP_TYPE_VSM"),e}function A_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vs:case bs:e="ENVMAP_TYPE_CUBE";break;case Ca:e="ENVMAP_TYPE_CUBE_UV";break}return e}function R_(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===bs&&(e="ENVMAP_MODE_REFRACTION"),e}function C_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Jl:e="ENVMAP_BLENDING_MULTIPLY";break;case mf:e="ENVMAP_BLENDING_MIX";break;case gf:e="ENVMAP_BLENDING_ADD";break}return e}function P_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function k_(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=T_(t),c=A_(t),u=R_(t),d=C_(t),h=P_(t),f=v_(t),g=b_(r),v=s.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <div class="sub">${E(t,{remainder:i.remainder})}</div>`}}const ly=Object.freeze(Object.defineProperty({__proto__:null,advanceBubble:Mc,bubbleOpen:oy,formatEquation:Ba,hideBanner:Sc,hideBubble:ks,hideModelPanel:Oa,initHud:bh,say:gn,setAction:Aa,setActionReady:ay,setBananas:Mh,setBanner:xh,setCombo:Hl,setEgg:Eh,setStreak:wh,setVerbPanel:wc,showHintButton:fr,showHud:Vn,showModelPanel:Vl,solveBanner:yh,toast:Wt,wiggleBanner:Sh},Symbol.toStringTag,{value:"Module"})),Rh=i=>document.getElementById(i),Wl=()=>Rh("screens"),Ch={bunny:"🐰",duckling:"🐥",kitten:"🐱",piglet:"🐷",redpanda:"🦊",turtle:"🐢",owl:"🦉",dragon:"🐉"},Ph={cap:"🧢",bow:"🎀",crown:"👑",flowercrown:"🌸",beanie:"🧶",wizard:"🧙‍♂️",pirate:"🏴‍☠️",party:"🥳"},cy={sparkle:"✨",petal:"🌸",bubble:"🫧",star:"⭐"},uy={tide:"🌊",garden:"🌱",stump:"🥥",vines:"🍇"};function pn(){Wl().innerHTML=""}function Tt(i,e=""){const t=["screen",e].filter(Boolean).join(" ");Wl().innerHTML=`<div class="${t}">${i}</div>`;const n=Wl().firstElementChild;return n.tabIndex=-1,n.focus?.({preventScroll:!0}),n}function kn(i,e=null){return`<button class="round-btn screen-close" id="scr-back" aria-label="${ge(E("nav.back"))}">${e||"✖️"}</button>`}function Ra(i){const e=document.createElement("div");e.className="toast",e.textContent=i,Rh("toasts").appendChild(e),setTimeout(()=>e.remove(),2600)}function ge(i){return String(i).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const dy={en:{label:"English",className:"flag-gb"},nl:{label:"Nederlands",className:"flag-nl"}};function ws(i,e){const t=dy[i];if(!t)throw new Error(`Unknown language flag: ${i}`);return`<button class="round-btn lang-btn${i===e?" active":""}" data-lang="${i}" aria-label="${t.label}" title="${t.label}"><span class="flag-icon ${t.className}" aria-hidden="true"></span></button>`}function Ot(i){const e=(Number(i||0)/100).toFixed(2);return`€${(cn().lang||"en")==="en"?e:e.replace(".",",")}`}function kh(i){if(!i)return null;const e=Pn("NL_PO").objectives.find(t=>t.id===i);return e?.titleKey?E(e.titleKey):null}function Lh(i){return kh(Fi[i]?.objectiveId)}function Ec(i){return kh(i?.objectiveId)||Lh(i?.mode)||(i?.kind==="payment"?E("business.pay"):null)||(i?.kind==="prep"?E("business.prep"):null)||E("business.order")}function mS({order:i,customerName:e,activeTask:t,bakeStatus:n="raw",onPrep:s,onPay:r,onServe:a,onExit:o}){const l=Oi[i.recipeId],c=l.kind==="pizza"?"business.zone.pizzeria":"business.zone.bakery",u=t||i.tasks[0],d=u&&u.kind==="prep",h=u&&u.kind==="payment",f=Tt(`
    <div class="business-panel">
      ...
      <div class="card business-order-card">
        ...
        <div class="tagline">${ge(Ec(u))}</div>
      </div>
    </div>
  `,"business-screen");f.querySelector("#business-prep").addEventListener("click",()=>{d&&s?.(u)}),f.querySelector("#business-pay").addEventListener("click",()=>{h&&r?.(u)}),f.querySelector("#business-serve").addEventListener("click",a),f.querySelector("#business-close").addEventListener("click",o)}function us(i,e,t){const n=Number(i),s=Number.isFinite(n)?[n,...e.map(r=>n+r)].filter(r=>r>=0):t;return[...new Set(s.map(r=>Number(r)))].sort((r,a)=>r-a)}function hy(i,e){for(const t of i.closest(".card")?.querySelectorAll(e)||[])t.classList.remove("equipped");i.classList.add("equipped")}function os(i,e,t,n){return`
    <button class="tile pressable" data-${i}="${ge(e)}">
      <div class="t-icon">${ge(t)}</div>
      ${n?`<div class="t-name">${ge(n)}</div>`:""}
    </button>`}function Qn(i,e,t){for(const n of i.querySelectorAll(e))n.addEventListener("click",()=>{t(n),hy(n,e)})}const ad={portion_halves_quarters:{prompt:()=>E("business.prep.portion"),controls(i){const e=i.expected||{},t=[...new Set([2,4,6,8,Number(e.slices)].filter(Number.isFinite))].sort((s,r)=>s-r),n=[...new Set(["cheese","tomato",e.topping].filter(Boolean))];return`
        ...
        </div>`).join("")},bind(i,e){e.ingredients={};for(const t of i.querySelectorAll("[data-scale-ingredient]"))t.addEventListener("click",()=>{const n=t.dataset.scaleIngredient;e.ingredients[n]=Number(t.dataset.scaleAmount);for(const s of i.querySelectorAll(`[data-scale-ingredient="${n}"]`))s.classList.remove("equipped");t.classList.add("equipped")})},submit:i=>({ingredients:{...i.ingredients||{}}})}};function Dh(i,{task:e,view:t,action:n,doneId:s,onSubmit:r,onClose:a}){i.querySelector("#scr-back").addEventListener("click",a),t.bind(i,n,e);const o=i.querySelector("#business-feedback"),l=u=>{o.textContent=u,o.hidden=!1},c=()=>E("business.hint."+e.mode);i.querySelector("#business-hint").addEventListener("click",()=>l(c())),i.querySelector("#"+s).addEventListener("click",()=>{const u=r?.(t.submit(n));u&&u.correct===!1&&!u.handled&&l(`${E("business.almost")} ${c()}`)})}function gS({task:i,onSubmit:e,onClose:t}){const n=ad[i?.mode]||ad.portion_halves_quarters,s={},r=Tt(`
    ${kn(t,"←")}
    <h2>${E("business.prep")}</h2>
    <div class="tagline">${ge(Ec(i))}</div>
    <div class="card">
  ...
  `);Dh(r,{task:i,view:n,action:s,doneId:"business-prep-done",onSubmit:e,onClose:t})}const fy=[500,200,100,50,20,10,5],od={money_make_amounts:{controls(i){const e=i.expected?.amountCents??0;return`
        ...
        <div class="business-money-row">
          ${fy.map(t=>`<button class="btn soft" data-money="${t}">${Ot(t)}</button>`).join("")}
        </div>
        <div class="menu-row">
        ...
        </div>`},bind(i,e){Qn(i,"[data-final]",t=>{e.finalCents=Number(t.dataset.final)})},submit:i=>({finalCents:i.finalCents})}};function _S({task:i,onSubmit:e,onClose:t}){const n=od[i?.mode]||od.money_make_amounts,s={},r=Tt(`
    ${kn(t,"←")}
  ...
  `);Dh(r,{task:i,view:n,action:s,doneId:"business-payment-done",onSubmit:e,onClose:t})}function vS({business:i,onRestock:e,onClose:t}){const n=Math.max(1,i.stockLimit||1),s=Tt(`
    ${kn()}
  ...
  `);s.querySelector("#scr-back").addEventListener("click",t);for(const r of s.querySelectorAll("[data-restock]"))r.addEventListener("click",()=>e?.(r.dataset.restock))}function bS({business:i,onBuy:e,onClose:t}){const n=Array.isArray(i.upgrades)?i.upgrades:[],s=Tt(`
    ${kn()}
    <h2>${E("business.upgrades")}</h2>
    <div class="chip">${E("business.profit")}: ${Ot(i.shopCoins)}</div>
    <div class="card">
      ${Object.values(ah).map(r=>{const a=n.includes(r.id);return`
          <div class="skill-row">
            <div class="s-name">${E(r.titleKey)}</div>
  ...
  `);s.querySelector("#scr-back").addEventListener("click",t);for(const r of s.querySelectorAll("[data-upgrade]"))r.addEventListener("click",()=>e?.(r.dataset.upgrade))}function Fh(i){return`${i.countryKey?E(i.countryKey):i.countryCode||i.id} - ${E(i.titleKey)}`}function py(i,e){const t=i.stages.find(n=>n.id===e);return t?E(t.labelKey):E(i.fallbackStagePrefixKey||"curriculum.stage",{n:"?"})}function my(i,e,t=null,n=!1){if(!i?.curriculum||!e)return"";const s=Pn(i.curriculum.packId),r=nh(),a=Wv(s.id,e,{business:t}),o=i.curriculum.confirmedStage||i.curriculum.estimatedStage,l=i.curriculum.strictness||"soft";return`
    <div class="card">
      ...
      <div class="curriculum-meta">
        ...
        <div class="chip">${ge(E("parents.stage"))}: ${ge(py(s,o))}</div>
      </div>
      ${n?`<div class="curriculum-controls">
        <label>
          <span>${ge(E("parents.curriculum_pack"))}</span>
          <select data-pack>
            ${r.map(c=>`<option value="${ge(c.id)}" ${c.id===s.id?"selected":""}>${ge(Fh(c))}</option>`).join("")}
          </select>
        </label>
        <label>
      ...
      `).join("")}
    </div>`}function gy(i){if(!i)return"";const e=Object.entries(i.modes||{});return`
    <div class="card">
      ...
      <div class="curriculum-objectives">
        ${e.map(([t,n])=>{const s=n?.coverage||"partial",r=Lh(t)||E("parents.business");return`<span class="curriculum-pill ${ge(s)}">${ge(r)} · ${ge(E(`parents.${s}`))}</span>`}).join("")}
      </div>
    </div>`}function _y({report:i,profile:e,businessReport:t=null,onClose:n,onCurriculumChange:s}){const r=Tt(`
    ${kn()}
    ...
    <div class="card">
      ...
      <div id="new-player-row" class="new-player-form hidden">
        ...
        <select id="new-pack" aria-label="${ge(E("title.curriculum_prompt"))}"
          ...
          ${r.map(l=>`<option value="${ge(l.id)}">${ge(Fh(l))}</option>`).join("")}
        </select>
  ...
  `);s.querySelector("#story-next").addEventListener("click",()=>{if(Q.sfx("click"),e++,e>=t.length){i();return}s.querySelector("#story-face").textContent=n[e],s.querySelector("#story-text").innerHTML=t[e],e===t.length-1&&(s.querySelector("#story-next").textContent=E("title.start")+" 🍌")})}function by(i){let e=0;const t=[E("finale.1"),E("finale.2"),E("finale.3"),E("finale.4")],n=["🦀","🦀","🦀","🐵"],s=Tt(`
    ...
    <button class="btn green" id="story-next">${E("ui.ok")} →</button>
    <div style="flex:2"></div>
  `);s.querySelector("#story-next").addEventListener("click",()=>{if(Q.sfx("click"),e++,e>=t.length){i();return}s.querySelector("#story-face").textContent=n[e],s.querySelector("#story-text").innerHTML=t[e],e===t.length-1&&(s.querySelector("#story-next").textContent="🎪 "+E("title.start"))})}function xy({problems:i,onAnswer:e,onDone:t,onSkip:n}){let s=!1,r=!1,a=0,o=!1;const l=d=>r?!1:(r=!0,d?.(),!0),c=()=>{o=!1;const d=i[a],h=Array.isArray(d?.choices)?d.choices:[],f=d?.prompt?.key?E(My(d.prompt.key),Sy(d)):E("placement.answer"),g=Tt(`
      <div style="flex:1"></div>
      ...
      <div class="card placement-card">
        ...
        <div class="placement-eq">${yy(d?.equation||"")}</div>
        <div class="tile-grid">
          ${h.map(v=>`
    ...
    `);for(const v of g.querySelectorAll("[data-value]"))v.addEventListener("click",()=>{if(r||o)return;o=!0;for(const p of g.querySelectorAll("[data-value]"))p.disabled=!0;const m=String(v.dataset.value)===String(d.answer);if(e({problem:d,correct:m}),a+=1,a>=i.length){Ra(E("placement.done")),l(t);return}c()});g.querySelector("#warmup-skip")?.addEventListener("click",()=>l(n))},u=()=>{const d=Tt(`
      ...
      <div style="flex:2"></div>
    `);d.querySelector("#warmup-start")?.addEventListener("click",()=>{if(!(r||s)){s=!0;for(const h of d.querySelectorAll("button"))h.disabled=!0;if(!i.length){l(n);return}c()}}),d.querySelector("#warmup-skip")?.addEventListener("click",()=>l(n))};(!s||!i.length)&&u()}function yy(i){return ge(i).replace(/(\d+)\s*\/\s*(\d+)/g,'<span class="frac"><span class="n">$1</span><span class="d">$2</span></span>').replace(/\?/g,'<span class="slot">?</span>')}function Sy(i){const e={...i?.meta||{},...i?.model?.params||{},...i?.prompt?.vars||{}};return e.n!==void 0&&e.d!==void 0&&(e.frac=`${e.n}/${e.d}`),e.answer=i?.answer,e}function My(i){return{"q.compare":"warmup.q.compare","q.equiv":"warmup.q.equiv","q.frac_of":"warmup.q.frac_of","q.missing":"warmup.q.missing","q.share_fetch":"warmup.q.share_fetch"}[i]||"warmup.q.fetch"}function zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n}){const s=cn(),r=Tt(`
    ${kn()}
  ...
  `);r.querySelector("#scr-back").addEventListener("click",i);for(const a of r.querySelectorAll("[data-lang]"))a.addEventListener("click",()=>{yc(a.dataset.lang),Wn(),t?.(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})});r.querySelector("#tg-sfx").addEventListener("click",()=>{s.sfx=!s.sfx,Q.setSfx(s.sfx),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-music").addEventListener("click",()=>{s.music=!s.music,Q.setMusic(s.music),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-motion").addEventListener("click",()=>{s.reduceMotion=!Pi(),ls(),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-font").addEventListener("click",()=>{s.dyslexiaFont=!s.dyslexiaFont,ls(),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-contrast").addEventListener("click",()=>{s.highContrast=!s.highContrast,ls(),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-colorblind").addEventListener("click",()=>{s.colorblind=!s.colorblind,ls(),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#tg-textsize").addEventListener("click",()=>{const a=[1,1.15,1.3],o=a.findIndex(l=>Math.abs(l-(s.textScale||1))<.01);s.textScale=a[(o+1)%a.length],ls(),Ze(),zn({onClose:i,onSwitchPlayer:e,onLangChange:t,devTools:n})}),r.querySelector("#switch-player").addEventListener("click",e),r.querySelector("#settings-extra-toggle")?.addEventListener("click",()=>n?.onToggle?.(!n.open));for(const a of r.querySelectorAll("[data-settings-preset]"))a.addEventListener("click",()=>n?.onApply?.(a.dataset.settingsPreset));r.querySelector("#settings-manual-devtools")?.addEventListener("submit",a=>{a.preventDefault()})}function ql({onClose:i,onChanged:e}){const t=vr(),n=[{id:"hats",label:E("shop.hats"),items:bc,owned:t.owned.hats,slot:"hat",icon:a=>Ph[a.id]||"🎩"},{id:"furs",label:E("shop.furs"),items:Gl,owned:t.owned.furs,slot:"fur",icon:a=>`<span style="display:inline-block;width:30px;height:30px;border-radius:50%;background:${a.palette?.F||"#a8743f"};border:3px solid #fff"></span>`},{id:"trails",label:E("shop.trails"),items:ox,owned:t.owned.trails,slot:"trail",icon:a=>cy[a.id]||"✨"}];let s=ql._tab||"hats";const r=()=>{const a=n.find(l=>l.id===s),o=Tt(`
    ...
    `);o.querySelector("#scr-back").addEventListener("click",i);for(const l of o.querySelectorAll("[data-tab]"))l.addEventListener("click",()=>{ql._tab=s=l.dataset.tab,Q.sfx("click"),r()});o.querySelector("#buy-freeze").addEventListener("click",()=>{Zu(t,St.streakFreezePrice)?(t.streak.freezes++,Ze(),Q.sfx("chest"),r(),e?.()):(Q.sfx("boop"),Ra(E("shop.too_pricey")))});for(const l of o.querySelectorAll("[data-item]"))l.addEventListener("click",()=>{const c=n.find(h=>h.id===s),u=c.items.find(h=>h.id===l.dataset.item);if(c.owned.includes(u.id))Nl(t,c.slot,t.avatar[c.slot]===u.id&&c.slot==="hat"?null:u.id),Q.sfx("pick");else if(Zu(t,u.price))wb(t,c.id,u.id),Nl(t,c.slot,u.id),Q.sfx("chest");else{Q.sfx("boop"),Ra(E("shop.too_pricey"));return}r(),e?.()})};r()}function jl({onClose:i,onChanged:e,onHatch:t}){const n=vr(),s=n.egg.points>=n.egg.goal,r=Tt(`
    ${kn()}
    <h2>🐾 ${E("pets.title")}</h2>
    ...
    <div class="card">
      ...
      <div class="tile-grid">
        ${Ps.map(a=>{const o=n.pets.includes(a.id),l=n.avatar.pet===a.id;return`<div class="tile pressable ${o?"owned":"locked"} ${l?"equipped":""}" data-pet="${a.id}">
            <div class="t-rarity">${qd[a.rarity]}</div>
  ...
  `);r.querySelector("#scr-back").addEventListener("click",i),r.querySelector("#hatch-now")?.addEventListener("click",t);for(const a of r.querySelectorAll("[data-pet]"))a.addEventListener("click",()=>{const o=a.dataset.pet;if(!n.pets.includes(o)){Q.sfx("boop");return}Nl(n,"pet",n.avatar.pet===o?null:o),Q.sfx("pick"),jl({onClose:i,onChanged:e,onHatch:t}),e?.()})}function wy(i,e){let t=0,n=!1;const s=Tt(`
    <div style="flex:1"></div>
    <div id="hatch-egg">🥚</div>
    <div class="tagline" id="hatch-label">${E("egg.hatch")}</div>
    <div style="flex:2"></div>
  `),r=s.querySelector("#hatch-egg");r.addEventListener("click",()=>{n||(t++,Q.sfx("egg",{pitch:1+t*.15}),r.classList.add("cracking"),t>=3&&(n=!0,Q.sfx("hatch"),r.textContent=i?Ch[i.id]||"🐾":"💛",r.classList.remove("cracking"),r.style.animation="chest-bounce .8s cubic-bezier(.34,1.56,.64,1)",s.querySelector("#hatch-label").innerHTML=i?`${E("egg.hatched",{pet:E(i.nameKey)})} ${qd[i.rarity]}`:E("egg.all_pets"),setTimeout(e,2200)))})}function Ey({profile:i,status:e,onClose:t,onFund:n}){const s=e.filter(o=>o.state==="built").length,r=(o,l,c,u,d=!1)=>`
    ...
    <div class="card">
      ...
      ${Object.entries(i.worlds).map(([r,a])=>`
        <div style="margin-bottom:8px">
          <div style="font-weight:900">${uy[r]} ${E("world."+r)}</div>
          ${a.skills.map(o=>`
            <div class="skill-row">
  ...
  `).querySelector("#scr-back").addEventListener("click",e)}function Ay({rewards:i,onNext:e,onHome:t}){const n=Tt(`
    <div style="flex:1"></div>
